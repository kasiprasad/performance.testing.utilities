                                ...
                                <table cellpadding="0" cellspacing="0" border="1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span data-bind="text: TotalTests" />
                                            </td>
                                            <td>
                                                <span data-bind="text: TotalTestsPassed" />
                                            </td>
                                            <td>
                                                <span data-bind="text: TotalTestsFailed" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>    
                                    ...
                                    <div data-bind="foreach: Requests">
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="1">
                                            <thead>
                                                <tr>
                                                    <th colspan="2">
                                                        <span data-bind="text: WebTestName"></span><br />
                                                        <span data-bind="text: ScenarioName"></span><br />
